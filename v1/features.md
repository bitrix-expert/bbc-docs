...
1. Глобально для всех ББК, установив константу `BX_EXC_NOTIFY` в значение `false`. Сделать это можно, например, в файле [init.php](https://dev.1c-bitrix.ru/learning/course/?COURSE_ID=43&LESSON_ID=2916).
